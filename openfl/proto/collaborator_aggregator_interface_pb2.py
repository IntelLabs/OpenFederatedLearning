...
_LOCALMODELUPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_num', full_name='openfl_proto.LocalModelUpdate.model_num', index=4,
...
_LOCALVALIDATIONRESULTS_RESULTSENTRY = _descriptor.Descriptor(
  name='ResultsEntry',
  full_name='openfl_proto.LocalValidationResults.ResultsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='openfl_proto.LocalValidationResults.ResultsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='openfl_proto.LocalValidationResults.ResultsEntry.value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCALVALIDATIONRESULTS = _descriptor.Descriptor(
  ...
  nested_types=[_LOCALVALIDATIONRESULTS_RESULTSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MODELDOWNLOADREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_num', full_name='openfl_proto.ModelDownloadRequest.model_num', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCALVALIDATIONRESULTS_RESULTSENTRY.containing_type = _LOCALVALIDATIONRESULTS
...
_LOCALVALIDATIONRESULTS.fields_by_name['results'].message_type = _LOCALVALIDATIONRESULTS_RESULTSENTRY
...
LocalValidationResults = _reflection.GeneratedProtocolMessageType('LocalValidationResults', (_message.Message,), {
  ...
  'ResultsEntry' : _reflection.GeneratedProtocolMessageType('ResultsEntry', (_message.Message,), {
    'DESCRIPTOR' : _LOCALVALIDATIONRESULTS_RESULTSENTRY,
    '__module__' : 'collaborator_aggregator_interface_pb2'
    # @@protoc_insertion_point(class_scope:openfl_proto.LocalValidationResults.ResultsEntry)
    })
  ,
...
_sym_db.RegisterMessage(LocalValidationResults.ResultsEntry)
...
_LOCALVALIDATIONRESULTS_RESULTSENTRY._options = None
