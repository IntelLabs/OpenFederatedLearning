    ...
    def do_train_job(self):
        ...
        for i in range(self.num_retries):
            try:
                ...
                self.logger.warning("Retrying upload of model. Retry {} of {}".format(i+1, self.num_retries))
    ...
    def do_download_model_job(self):
        ...
        for i in range(self.num_retries):
            try:
                ...
                self.logger.exception(repr(e))
                self.logger.warning("Retrying download of model. Retry {} of {}".format(i+1, self.num_retries))
